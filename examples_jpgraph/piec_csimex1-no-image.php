...
// $Id: piec_csimex1-no-image.php,v 1.1.2.1 2003/10/09 21:05:39 aditus Exp $
...
$targ=array("piec_csimex1-no-image.php#1","piec_csimex1-no-image.php#2","piec_csimex1-no-image.php#3",
	    "piec_csimex1-no-image.php#4","piec_csimex1-no-image.php#5","piec_csimex1-no-image.php#6");
$alts=array("val=%d","val=%d","val=%d","val=%d","val=%d","val=%d");
$p1->SetCSIMTargets($targ,$alts);
$p1->SetMidCSIM("piec_csimex1-no-image.php#7","Center");
